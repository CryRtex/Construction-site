...
const data = [
  {
    ...
    commentCount: 15,
    link: '#!',
    title: `Çelik koşullarında öz doğanay yapı  ile çelik yapılarınızın sağlamlığını arttırın`,
  },
  {
    id: 2,
    thumb: thumb2,
    commentCount: 15,
    link: '#!',
    title: `Çelik yapılar ve doğru bilinen yanlışlar hakkında bilgi edinin`,
  },
  {
    id: 3,
    thumb: thumb3,
    commentCount: 18,
    link: '#!',
    title: `Yapıların avantajları ve kullanım alanları hakkında bilinmeyenleri öğrenin` 
  },
];
  ...
  return (
    <Box id="blog" as="section" sx={styles.section}>
      <Container>
        <SectionHeading
          sx={styles.heading}
          slogan="Doğru Bilinenler Hakkında :)" 
          title="Sizler için özel bir blog yazısı"
        />
