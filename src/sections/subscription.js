    ...
    <Box as="section" sx={styles.section}>
      <Container>
        <Box sx={styles.content}>
          <SectionHeading
            sx={styles.heading}
            title="Uygun Teklif Al"
            description="Postanızla abone olarak, şartları kabul etmiş olursunuz"
          />
          <Flex as="form" sx={styles.form} onSubmit={handleSubmit}>
            <Box as="label" htmlFor="email" variant="styles.srOnly">
              Email
            </Box>
            <Input type="email" id="email" placeholder="Mail Adresini Gir" />
            <Button variant="white">Teklif Al</Button>
          </Flex>
        </Box>
      </Container>
    </Box>
