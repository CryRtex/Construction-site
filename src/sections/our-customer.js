...
import customer from 'assets/images/home.png';
      ...
      <Container>
        <Flex sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              sx={styles.heading}
              title="Bizimle çalışan yüzlerce firmadan bazısı burada."
              description="Yapılarında çelik tercih eden kurumlar yapıları için sağlamlığına güvendikleri Öz Doğanay Markası Aysteel çelik çatı sistemlerini tercih ediyor."
            />
