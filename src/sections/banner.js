      ...
      <Container>
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.bannerContent}>
            ...
            Endüstriyel inşaat sektöründe 
            hayalinizdeki yapıları projeden temele; 
            temelden anahtar teslim şekilde sizlere sunuyor. 
...
const styles = {
  section: {
    background: `url(${bannerBg}) no-repeat right center / cover`,
    backgroundSize: ['65%', null, null, null, 'relative'],
  },
  contentWrapper: {
    display: 'flex',
    alignItems: 'center',
